    ...
    <div class="flex max-w-md flex-col gap-4">
        <Card :style="themeStyles">
            <CardHeader>
                ...
                <CardDescription> You are currently on the free plan. Upgrade to the pro plan to get access to all features. </CardDescription>
            </CardHeader>
            <CardContent>
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="grid grid-cols-2 gap-3 md:grid-cols-[1fr_80px_60px]">
                            <Input id="card-number" placeholder="1234 1234 1234 1234" class="col-span-2 md:col-span-1" />
                        ...
                        <Select v-model="theme">
                            <SelectTrigger id="color" class="w-full">
                                <SelectValue>
                                    ...
                                    <template v-else> Select a color </template>
                                </SelectValue>
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <fieldset class="flex flex-col gap-3">
                        ...
                        <RadioGroup default-value="starter" class="grid gap-3 md:grid-cols-2">
                            <Label
                                v-for="plan in plans"
                                :key="plan.id"
                                class="flex items-start gap-3 rounded-lg border p-3 has-[[data-state=checked]]:border-ring has-[[data-state=checked]]:bg-ring/10"
                            >
                                <RadioGroupItem :id="plan.name" :value="plan.id" class="data-[state=checked]:border-primary" />
