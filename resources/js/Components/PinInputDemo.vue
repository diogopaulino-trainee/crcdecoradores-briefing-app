...
import { PinInput, PinInputGroup, PinInputSeparator, PinInputSlot } from '@/registry/new-york-v4/ui/pin-input';
...
<template>
    <div class="flex flex-col flex-wrap gap-6 md:flex-row">
        ...
        <div class="grid gap-2">
            ...
            <PinInput id="with-separator" v-model="value" :max-length="6">
                <PinInputGroup>
                    <PinInputSlot :index="0" />
                    <PinInputSlot :index="1" />
                </PinInputGroup>
