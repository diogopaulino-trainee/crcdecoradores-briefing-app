...
<template>
    <div class="flex flex-wrap items-start gap-4">
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="start" class="w-56">
                ...
                <DropdownMenuGroup>
                    ...
                    <DropdownMenuCheckboxItem v-model="showActivityBar" disabled> Activity Bar </DropdownMenuCheckboxItem>
        ...
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
                <Button variant="outline" class="h-12 justify-start px-2 md:max-w-[200px]">
                    <Avatar>
                    ...
                    <ChevronsUpDownIcon class="ml-auto text-muted-foreground" />
                </Button>
            </DropdownMenuTrigger>
        ...
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
                <Button variant="outline" class="size-8 rounded-full border-none p-0">
                    <Avatar>
                        <AvatarImage src="https://github.com/leerob.png" alt="leerob" />
                        <AvatarFallback class="rounded-lg"> LR </AvatarFallback>
                    </Avatar>
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent class="w-(--reka-dropdown-menu-trigger-width) min-w-56" align="start">
                <DropdownMenuLabel class="p-0 font-normal">
                    <div class="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                        ...
                        <div class="grid flex-1 text-left text-sm leading-tight">
                            ...
                            <span class="truncate text-xs text-muted-foreground"> leerob@example.com </span>
                        </div>
                    </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
