...
<template>
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-wrap items-center gap-2 md:flex-row">
            ...
            <Button variant="outline" size="sm"> Learn More <ArrowRightIcon /> </Button>
        ...
        <div class="flex flex-wrap items-center gap-2 md:flex-row">
            ...
            <Button variant="outline" size="lg"> <SendIcon /> Send </Button>
            <Button variant="outline" size="lg"> Learn More <ArrowRightIcon /> </Button>
