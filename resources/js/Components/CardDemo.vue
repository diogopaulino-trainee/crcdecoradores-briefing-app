    ...
    <div class="flex flex-col items-start gap-4">
        ...
        <Card>
            ...
            <CardFooter class="flex items-center gap-2">
                <Badge variant="outline"> <BedIcon /> 4 </Badge>
                <Badge variant="outline"> <BathIcon /> 2 </Badge>
                <Badge variant="outline"> <LandPlotIcon /> 350m² </Badge>
        ...
        <div class="flex w-full flex-wrap items-start gap-8 md:*:data-[slot=card]:basis-1/4">
            <Card>
                <CardContent class="text-sm"> Content Only </CardContent>
            </Card>
            <Card>
                <CardHeader>
            ...
            <Card>
                <CardFooter class="text-sm"> Footer Only </CardFooter>
            </Card>
            <Card>
                <CardHeader>
                ...
                <CardFooter class="text-sm"> Footer </CardFooter>
            </Card>
            <Card>
                <CardContent class="text-sm"> Content </CardContent>
                <CardFooter class="text-sm"> Footer </CardFooter>
