        ...
        <Combobox v-model="selectedTimezone" by="label">
            ...
            <ComboboxList class="w-72" :align="'start'">
                ...
                <ComboboxViewport class="max-h-[260px]">
                    ...
                    <ComboboxGroup v-for="region in timezones" :key="region.label" :heading="region.label">
                        <ComboboxItem v-for="timezone in region.timezones" :key="timezone.value" :value="timezone">
                            {{ timezone.label }}
        ...
        <Combobox v-model="selectedFrameworks" multiple by="label">
            ...
            <ComboboxList class="w-[300px]" :align="'start'">
                ...
                <ComboboxGroup>
                    <ComboboxItem v-for="framework in frameworks" :key="framework.value" :value="framework">
                        <div
                            class="*:[svg]:opacity-0 data-[selected=true]:*:[svg]:opacity-100 pointer-events-none size-4 shrink-0 select-none rounded-[4px] border border-input transition-all data-[selected=true]:border-primary data-[selected=true]:bg-primary data-[selected=true]:text-primary-foreground"
