    ...
    <div class="flex flex-col items-start gap-4 md:flex-row">
        <Popover>
            <PopoverTrigger as-child>
                <Button :variant="'outline'" :class="cn('min-w-[200px] justify-start px-2 font-normal', !date && 'text-muted-foreground')">
        ...
        <Popover>
            <PopoverTrigger as-child>
                <Button id="date" :variant="'outline'" :class="cn('w-fit justify-start px-2 font-normal', !dateRange && 'text-muted-foreground')">
                    <CalendarIcon class="text-muted-foreground" />
