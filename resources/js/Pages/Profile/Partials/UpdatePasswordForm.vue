...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-[#CAAC5F]">Atualizar Password</h2>

            <p class="mt-1 text-sm text-gray-600">
                Certifique-se de que a sua conta está a usar uma password longa e aleatória para manter-se segura.
            </p>
        </header>
