...
const form = useForm({
    ...
    data_da_proposta: props.proposta.data_da_proposta,
...
const submit = () => {
    form.post(route('propostas.update', props.proposta.id), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    ...
    <AppLayout>
        <div class="mx-auto max-w-6xl space-y-6 rounded bg-white p-8 shadow">
            <h2 class="text-2xl font-bold text-[#CDAA62]">Editar Proposta</h2>
