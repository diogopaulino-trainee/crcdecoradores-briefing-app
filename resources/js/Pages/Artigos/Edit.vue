...
<template>
    ...
    <AppLayout>
        <div class="mx-auto max-w-3xl space-y-6 rounded bg-white p-8 shadow">
            <h2 class="text-2xl font-bold text-[#CDAA62]">Editar Artigo</h2>
                ...
                <FormField name="iva">
                    <FormItem>
                        ...
                        <Select v-model="form.iva_id">
                            ...
                            <SelectContent>
                                <SelectItem v-for="iva in ivas" :key="iva.id" :value="iva.id"> {{ iva.percentagem }}% </SelectItem>
                            </SelectContent>
                        </Select>
                        <FormMessage>{{ form.errors.iva_id }}</FormMessage>
                    </FormItem>
                </FormField>
